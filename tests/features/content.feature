...
#    Then I should see the heading "My article"
  ...
  Scenario: Create many nodes
    ...
    And I should see "First landing page"
    And I should see "Second landing page"
...
#    And I should see "Tag two"
  ...
  Scenario: Create nodes with specific authorship
    ...
    | Landing page by Joe | Joe User | 1       |
    When I am logged in as a user with the "administrator" role
    When I go to "admin/content"
    Then I should see the link "Landing page by Joe"
    When I follow "Landing page by Joe"
    Then I should see the text "Landing page by Joe"
